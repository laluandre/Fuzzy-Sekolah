...
if ($row["status"] == "Diterima") {
  ...
  $status = "MAAF, ANDA TIDAK DITERIMA";
  $class = "alert alert-danger";
} else {
  $status = "Standby terus ya";
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img src="img/user.png" class="card-img" height="191px" alt="">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title"><?= $row["nama"]; ?></h5>
                  <p class="card-text">Jurusan Yang diminati :<t> <?= $row["jurusan"]; ?></p>
                  <p class="card-text"><small class="text-muted">Status Penerimaan : <?= $row["status"]; ?></small></p>
                </div>
              </div>
            </div>
          </div>
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Penerimaan akan diumumkan pada tanggal 34 April. Stay Tune ya!</p>
